...
import navConfigSub from './configsub'
// ----------------------------------------------------------------------
...
const StyledAccount = styled('div')(({ theme }) => ({
  ...
  backgroundColor: alpha(theme.palette.grey[100], 0.50),
}));
          ...
          <StyledAccount>
            ...
            <Box sx={{ ml: 2 }}>
              <Typography variant="subtitle2" sx={{ color: '#fff' }}>
                {changeUpperCase(userData?.firstName)}  {changeUpperCase(userData?.lastName)}
              </Typography>
