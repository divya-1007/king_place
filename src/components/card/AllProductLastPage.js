                    ...
                    <Typography variant="subtitle1" sx={{ ml: 5, p: 2 }}>
                      ...
                      >
                        ...
                        <Typography variant="h5" color="#2065d1">
                          ...
                          >
                            An extra bed will be provided to accommodate any
                            child included in the booking for a charge
                            mentioned. INR 1000 will be charged for an extra
                            sofa cum bed per child. (To be paid at the property)
                            An extra bed will be provided to accommodate any
                            additional guest included in the booking for a
                            charge mentioned. INR 1500 will be charged for an
                            extra cot per guest. (To be paid at the property)
                            INR 1000 will be charged for an extra sofa cum bed
                            per guest. (To be paid at the property)
                          </Typography>
                        </Typography>
                      </Typography>
